...
<source src ="https://abamela.fgsystem.net/vi.mp4" type=video/mp4 autostart=true>
</video>
</div>
                     ...
                     <div class="how-card">
                       ...
                       <div class="card-content">
                         <h4>Post a job (it’s free)</h4>
                          <p>Tell us about your project. Abamela connects you with top talent and agencies around the world, or near you.</p>
                       </div>
                     </div>
                     <div class="how-card">
                       <div class="how-icon"></div>
                     ...
                     <div class="how-card">
                       ...
                       <div class="card-content">
                         <h4>Collaborate easily</h4>
                          <p>Use Abamela to chat or video call, share files, and track project milestones from your desktop or mobile.</p>
                       </div>
                     </div>
                     <div class="how-card">
                       <div class="how-icon"></div>
                       <div class="card-content">
                         <h4>Payment simplified</h4>
                          <p>Pay hourly or fixed-price and receive invoices through Abamela. Pay for work you authorize.</p>
                       </div>
                     </div>
             </div>
        </section>
...
<br>
        <section class="pricing">
              <div class="pricing-heading">
                ...
                <P>All options include access to Abamela’s talent pool of quality talent and agencies.</P>
              </div>
        ...
        <section class="insta-page">
          <div class="insta-content">
            <div class="insta-left">
                 <h1>Instapage saved $2.3M with Abamela</h1>
                 <q>Abamela took a lot of stress off of growing with minimal resources</q>
        ...
        <footer>
          <div class="footer-top">
            <div><p>Looking to hire for long-term or full-time assignments? See how Abamela Payroll simplifies admin.</p></div>
            </div>
             ...
             <div class="copyright">
               copyights&copy all rights reserved Abamela.
             </div> 
        </footer>
...
<?php echo $__env->make($activeTemplate.'layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\abamela\core\resources\views/templates/basic/home.blade.php ENDPATH**/ ?>