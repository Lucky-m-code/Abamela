                    ...
                    <div class="table-responsive--md  table-responsive">
                        <table class="table table--light style--two">
                            ...
                            <tr>
                                ...
                                <th><?php echo app('translator')->get('Service Price'); ?></th>
                            ...
                            <tr <?php if($loop->odd): ?> class="table-light" <?php endif; ?>>
                                ...
                                <td data-label="<?php echo app('translator')->get('Seller'); ?>">
                                    <span class="font-weight-bold"><?php echo e($booking->service->user->fullname); ?></span>
                                    <br>
                                    <span class="small">
                                    <a href="<?php echo e(route('admin.users.detail', $booking->service->user_id)); ?>"><span>@</span><?php echo e($booking->service->user->username); ?></a>
                                    </span>
                                </td>
                                ...
                                <td data-label="<?php echo app('translator')->get('Delivery Date'); ?>">
                                    ...
                                    <br>
                                    <?php echo e(diffforhumans($booking->created_at->addDays($booking->service->delivery_time))); ?>

                                </td>

                                <td data-label="<?php echo app('translator')->get('Service Price'); ?>">
                                    <span class="font-weight-bold"><?php echo e($general->cur_sym); ?><?php echo e(getAmount($booking->service->price)); ?></span>
                                </td>

                                <td data-label="<?php echo app('translator')->get('Quantity'); ?>">
                                    <span class="font-weight-bold"><?php echo e(getAmount($booking->qty)); ?></span>
                                </td>
                                ...
                                <td data-label="<?php echo app('translator')->get('Action'); ?>">
                                    <a href="<?php echo e(route('admin.booking.service.details', $booking->id)); ?>" class="icon-btn" data-toggle="tooltip" title="" data-original-title="<?php echo app('translator')->get('Details'); ?>">
...
<?php $__env->startPush('breadcrumb-plugins'); ?>
    <form action="<?php echo e(route('admin.booking.service.search', $scope ?? str_replace('admin.booking.service.', '', request()->route()->getName()))); ?>" method="GET" class="form-inline float-sm-right bg--white">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\abamela\core\resources\views/admin/booking/index.blade.php ENDPATH**/ ?>