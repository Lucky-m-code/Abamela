        ...
        <div class="section-wrapper">
            <div class="row justify-content-center mb-30-none">
                ...
                <div class="col-xl-9 col-lg-12 mb-30">
                    ...
                    <form class="user-profile-form" action="<?php echo e(route('user.service.store')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                                    ...
                                    <div class="row justify-content-center">
                                        ...
                                        <div class="col-xl-6 col-lg-6 form-group">
                                            <div class="card custom--card p-0 mb-3">
                                                <div class="card-header d-flex flex-wrap align-items-center justify-content-between">
                                                    <h4 class="card-title mb-0">
                                                        <?php echo app('translator')->get('Optional Image'); ?>
                                                    </h4>
                                                    <div class="card-btn">
                                        ...
                                        <div class="col-xl-6 col-lg-6 form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="text" class="form-control" name="price" value="<?php echo e(old('price')); ?>" placeholder="<?php echo app('translator')->get('Enter Price'); ?>" required="">
                                        ...
                                        <div class="col-xl-6 col-lg-6 form-group">
                                            <label><?php echo app('translator')->get('Delivery Time'); ?></label>
                                                <div class="input-group mb-3">
                                                    <input type="text" class="form-control" name="delivery" value="<?php echo e(old('delivery')); ?>" placeholder="<?php echo app('translator')->get('Delivery Time'); ?>" required="">
                                        ...
                                        <div class="card custom--card p-0 mb-3">
                                            <div class="card-header d-flex flex-wrap align-items-center justify-content-between">
                                                <h4 class="card-title mb-0">
                                                    <?php echo app('translator')->get('Extra Service'); ?>
                                                </h4>
                                                <div class="card-btn">
                                                    <button type="button" class="btn--base addExtra"><i class="las la-plus"></i> <?php echo app('translator')->get('Add New'); ?></button>
                                                </div>
                                            </div>
                                            <div class="card-body">
                                        ...
                                        <div class="col-xl-12 form-group">
                                            <button type="submit" class="submit-btn mt-20 w-100"><?php echo app('translator')->get('CREATE SERVICE'); ?></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        var html = `
            <div class="col-lg-12 extraServiceRemove">
                ...
                <div class="col-xl-9 col-lg-12 form-group">
                    <input type="text" name="extra_title[]" class="form-control" placeholder="<?php echo app('translator')->get("Enter title"); ?>" required>
                </div>

                <div class="col-xl-2 col-lg-12 form-group">
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" name="extra_price[]" placeholder="<?php echo app('translator')->get('Enter Price'); ?>" required="">
                      <span class="input-group-text" id="basic-addon2"><?php echo e(__($general->cur_text)); ?></span>
                    </div>
                </div>
                <div class="col-xl-1">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make($activeTemplate.'layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\abamela\core\resources\views/templates/basic/user/seller/service/create.blade.php ENDPATH**/ ?>