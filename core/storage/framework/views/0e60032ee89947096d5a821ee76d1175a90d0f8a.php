        ...
        <div class="widget mb-30">
            ...
            <ul class="category-list">
                 <?php $__currentLoopData = $categorys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li><a href="<?php echo e(route('job.category', [slug($category->name),$category->id])); ?>"><?php echo e(__($category->name)); ?></a></li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </ul>
        </div>

        <form action="<?php echo e(route('job.filter.search')); ?>" method="GET">
            <div class="widget mb-30">
...
<?php $__env->stopPush(); ?><?php /**PATH C:\xampp\htdocs\abamela\core\resources\views/templates/basic/partials/job_filter.blade.php ENDPATH**/ ?>