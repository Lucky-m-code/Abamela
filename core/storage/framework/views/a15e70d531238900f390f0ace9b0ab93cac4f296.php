            ...
            <div class="card">
                <form action="<?php echo e(route('admin.staff.store')); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="name" maxlength="40"  value="<?php echo e(old('name')); ?>" name="name" placeholder="<?php echo app('translator')->get('Enter Name'); ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="username" maxlength="40"  value="<?php echo e(old('username')); ?>" name="username" placeholder="<?php echo app('translator')->get('Enter UserName'); ?>" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">  
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" id="email" value="<?php echo e(old('email')); ?>" name="email" maxlength="40" placeholder="<?php echo app('translator')->get('Enter Email'); ?>" required>
                                    </div>     
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-12">  
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control" id="password" name="password" placeholder="<?php echo app('translator')->get('Enter Password'); ?>" required="">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12"> 
                                    <div class="form-group">
                                        ...
                                        <input type="password" id="confirm_password" class="form-control"
                                            name="password_confirmation" placeholder="<?php echo app('translator')->get('Confirm Password'); ?>" autocomplete="new-password" required="">
                                            <p id="message"></p>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="form-group form-check">
                                                <?php $__currentLoopData = $permission; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <input type="checkbox" class="form-check-input" name="permission[]" value="<?php echo e($value->id); ?>" id="<?php echo e($value->id); ?>">
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn--primary btn-block"><?php echo app('translator')->get('Create Staff'); ?></button>
                    </div>
            </form>
        </div>
    </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\abamela\core\resources\views/admin/staff/create.blade.php ENDPATH**/ ?>