                                                ...
                                                <tr>
                                                    <td data-label="<?php echo app('translator')->get('Service'); ?>" class="text-start">
                                                        <div class="author-info">
                                                            ...
                                                            <div class="content"><a href="<?php echo e(route('service.details', [slug($booking->service->title), encrypt($booking->service->id)])); ?>"><?php echo e(__(str_limit($booking->service->title, 10))); ?></a></div>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td data-label="Action">
                                                        <a href="<?php echo e(route('user.booking.service.details', encrypt($booking->id))); ?>" class="btn btn--primary text-white ms-1"><i class="las la-desktop"></i></a>
                                                        <?php if($booking->working_status==0): ?>
                                                            ...
                                                            <a href="javascript:void(0)" class="btn btn--danger text-white cancelBtn ms-1" data-order_number="<?php echo e($booking->order_number); ?>" data-bs-toggle="modal" data-bs-target="#cancelModal"><i class="las la-times"></i></a>
                                                        <?php elseif($booking->working_status == 4 ): ?>
...
<?php echo $__env->make($activeTemplate.'layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\abamela\core\resources\views/templates/basic/user/seller/service_booking.blade.php ENDPATH**/ ?>