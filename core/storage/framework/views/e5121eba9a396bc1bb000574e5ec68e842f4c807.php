        ...
        <div class="section-wrapper">
            <div class="row justify-content-center mb-30-none">
                ...
                <div class="col-xl-9 col-lg-12 mb-30">
                    ...
                    <form class="user-profile-form" action="<?php echo e(route('user.job.store')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                                    ...
                                    <div class="row justify-content-center">
                                        ...
                                        <div class="col-xl-6 col-lg-6 form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="text" class="form-control" name="amount" value="<?php echo e(old('amount')); ?>" placeholder="<?php echo app('translator')->get('Enter Budget'); ?>" required="">
                                        ...
                                        <div class="col-xl-12 col-lg-12 form-group">
                                            ...
                                            <textarea class="form-control bg--gray nicEdit" name="requirement"><?php echo e(old('requirement')); ?></textarea>
                                        </div>

                                        <div class="col-xl-12 form-group">
                                            <button type="submit" class="submit-btn mt-20 w-100"><?php echo app('translator')->get('CREATE JOB'); ?></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make($activeTemplate.'layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\abamela\core\resources\views/templates/basic/user/buyer/job/create.blade.php ENDPATH**/ ?>