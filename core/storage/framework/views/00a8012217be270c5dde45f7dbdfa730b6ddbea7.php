                        ...
                        <div class="row justify-content-center mb-30-none">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mb-30">
                                <div class="dashboard-item bg--primary">
                                    <a href="<?php echo e(route('user.seller.transactions')); ?>" class="dash-btn"><?php echo app('translator')->get('View all'); ?></a>
                                    <div class="dashboard-icon">
                                        <i class="las la-wallet"></i>
                                    </div>
                                    <div class="dashboard-content">
                                        <div class="num text-white"><?php echo e($general->cur_sym); ?><?php echo e(getAmount(auth()->user()->balance)); ?></div>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mb-30">
                                <div class="dashboard-item bg--info">
                                    ...
                                    <div class="dashboard-content">
                                        ...
                                        <h3 class="title text-white"><?php echo app('translator')->get('Total Software'); ?></h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mb-30">
                                <div class="dashboard-item bg--warning">
                                    ...
                                    <div class="dashboard-content">
                                        ...
                                        <h3 class="title text-white"><?php echo app('translator')->get('Total Software Sales'); ?></h3>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mb-30">
                                <div class="dashboard-item bg--success">
                                    ...
                                    <div class="dashboard-content">
                                        <div class="num text-white"><?php echo e($general->cur_sym); ?><?php echo e(getAmount($withdrawAmount)); ?></div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make($activeTemplate.'layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\abamela\core\resources\views/templates/basic/user/seller/dashboard.blade.php ENDPATH**/ ?>