                        ...
                        <div class="container">
                                        ...
                                        <?php $__currentLoopData = $subCategorys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subCategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="swiper-slide">
                                                <div class="category-item-box">
                                                    <a href="<?php echo e(route('service.sub.category', [slug($subCategory->name), $subCategory->id])); ?>">
                                ...
                                <div class="item-wrapper d-flex flex-wrap justify-content-between align-items-center">
                                    <div class="item-wrapper-left d-flex flex-wrap align-items-center">
                                        <div class="item-value">
                                            <span><?php echo app('translator')->get('Showing item'); ?>:&nbsp <span class="result">1 of <?php echo e($services->count()); ?></span></span>
                                        </div>
                                    </div>
                            ...
                            <div class="item-bottom-area">
                                <div class="row justify-content-center mb-30-none">
                                   ...
                                   <?php echo $__env->make($activeTemplate.'partials.service_category_filter', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make($activeTemplate.'layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\abamela\core\resources\views/templates/basic/service_category.blade.php ENDPATH**/ ?>