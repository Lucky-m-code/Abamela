                    ...
                    <form action="" method="POST">
                            ...
                            <div class="col-md-2">
                                <div class="form-group ">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control form-control-lg" type="text" name="depo_com" value="<?php echo e($general->depo_com); ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 form-group">
                                <label for="value" class="form-control-label font-weight-bold"><?php echo app('translator')->get('Search Max Value'); ?></label>
                                <div class="input-group mb-3">
                                      <input type="text" id="value" class="form-control form-control-lg" placeholder="<?php echo app('translator')->get('Enter Amount'); ?>" name="searchMax" value="<?php echo e(getAmount($general->search_max)); ?>" aria-label="Recipient's username" aria-describedby="basic-addon2" required="">
                                      <div class="input-group-append">
                            ...
                            <div class="col-md-3 form-group">
                                <label for="value" class="form-control-label font-weight-bold"><?php echo app('translator')->get('Charge'); ?></label>
                                <div class="input-group mb-3">
                                      <input type="text" id="value" class="form-control form-control-lg" placeholder="<?php echo app('translator')->get('Enter Amount'); ?>" name="charge" aria-label="Recipient's username" value="<?php echo e(getAmount($general->charge)); ?>" aria-describedby="basic-addon2" required="">
                                      <div class="input-group-append">
                        ...
                        <div class="row">
                             <div class="form-group col-md-3">
                                <label class="form-control-label font-weight-bold"><?php echo app('translator')->get('Approval Post Auto'); ?></label>
                                <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-toggle="toggle" data-on="<?php echo app('translator')->get('Enable'); ?>" data-off="<?php echo app('translator')->get('Disabled'); ?>" name="approval_post" <?php if($general->approval_post): ?> checked <?php endif; ?>>
                            </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\abamela\core\resources\views/admin/setting/general_setting.blade.php ENDPATH**/ ?>