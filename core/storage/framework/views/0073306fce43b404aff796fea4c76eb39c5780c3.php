                                                ...
                                                <tr>
                                                    <td data-label="<?php echo app('translator')->get('Title'); ?>" class="text-start">
                                                        <div class="author-info">
                                                            <div class="thumb">
                                                                <img src="<?php echo e(getImage('assets/images/software/'.$favoriteSoftware->software->image,'590x300')); ?>" alt="<?php echo app('translator')->get('software Image'); ?>">
                                                            </div>
                                                    ...
                                                    <td data-label="Action">
                                                        <a href="<?php echo e(route('software.details', [slug($favoriteSoftware->software->title), $favoriteSoftware->software_id])); ?>" class="btn btn--primary text-white"><i class="las la-desktop"></i></a>
                                                    </td>
                                                </tr>
...
<?php echo $__env->make($activeTemplate.'layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\abamela\core\resources\views/templates/basic/user/buyer/favorite_software.blade.php ENDPATH**/ ?>