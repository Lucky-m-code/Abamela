                                                ...
                                                <tr>
                                                    ...
                                                    <td data-label="Action">
                                                        ...
                                                        <?php if($hireEmploy->working_status==2): ?>
                                                            ...
                                                            <a href="javascript:void(0)" class="btn btn--danger text-white disputeBtn ms-1" data-id="<?php echo e($hireEmploy->order_number); ?>" data-bs-toggle="modal" data-bs-target="#disputeModal"><i class="las la-times"></i></a>
                                                        <?php endif; ?>
                                                    </td>
                                                </tr>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make($activeTemplate.'layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\abamela\core\resources\views/templates/basic/user/buyer/hire_employ.blade.php ENDPATH**/ ?>