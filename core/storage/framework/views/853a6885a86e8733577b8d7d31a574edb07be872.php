                            ...
                            <?php if($booking->workFile->isNotEmpty()): ?>
                                ...
                                <h4 class="text-center"><?php echo app('translator')->get('Work Delivery'); ?></h4>
                                    ...
                                    <div class="text-center mt-2">
                                        ...
                                        <a href="<?php echo e(route('user.work.file.download', encrypt($file->id))); ?>" class="btn btn--primary btn-rounded text-white"><?php echo app('translator')->get('File Download'); ?></a>
                                    </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                            <?php endif; ?>
...
<?php echo $__env->make($activeTemplate.'layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\abamela\core\resources\views/templates/basic/user/seller/service_booking_details.blade.php ENDPATH**/ ?>