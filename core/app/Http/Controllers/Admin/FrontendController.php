...
class FrontendController extends Controller
{
    ...
    public function seoEdit()
    {
        ...
        if(!$seo){
            $data_values = '{"keywords":["admin","blog"],"description":"upwork project addis ababa universty ","social_title":"WEBSITENAME","social_description":"upwork project addis ababa universtiy ","image":null}';
